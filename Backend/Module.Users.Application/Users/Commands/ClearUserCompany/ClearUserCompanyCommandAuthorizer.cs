...
{
    public class ClearUserCompanyCommandAuthorizer : IAuthorizer<ClearUserCompanyCommand>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly IMediator _mediator;
        public ClearUserCompanyCommandAuthorizer(IUserAccessor userAccessor,
            IMediator mediator)
        {
        ...
        public async Task AuthorizeAsync(ClearUserCompanyCommand request, CancellationToken cancellationToken = default)
        {
