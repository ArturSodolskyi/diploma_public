...
{
    public class GetTaskIdsByJobQueryAuthorizer : IAuthorizer<GetTaskIdsByJobQuery>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly IMediator _mediator;
        public GetTaskIdsByJobQueryAuthorizer(IUserAccessor userAccessor,
            IMediator mediator)
        {
        ...
        public async Task AuthorizeAsync(GetTaskIdsByJobQuery request, CancellationToken cancellationToken = default)
        {
