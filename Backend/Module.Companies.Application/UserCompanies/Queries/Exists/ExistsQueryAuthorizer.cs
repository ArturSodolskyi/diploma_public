...
{
    public class ExistsQueryAuthorizer : IAuthorizer<ExistsQuery>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly IMediator _mediator;
        public ExistsQueryAuthorizer(IUserAccessor userAccessor,
            IMediator mediator)
        {
        ...
        public async Task AuthorizeAsync(ExistsQuery request, CancellationToken cancellationToken = default)
        {
