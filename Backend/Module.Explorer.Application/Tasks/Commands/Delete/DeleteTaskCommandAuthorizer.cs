...
{
    public class DeleteTaskCommandAuthorizer : IAuthorizer<DeleteTaskCommand>
    {
        private readonly IExplorerDbContext _dbContext;
        private readonly IUserAccessor _userAccessor;
        private readonly IMediator _mediator;
        public DeleteTaskCommandAuthorizer(IExplorerDbContext dbContext,
        ...
        public async Task AuthorizeAsync(DeleteTaskCommand request, CancellationToken cancellationToken = default)
        {
