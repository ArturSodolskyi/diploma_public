...
{
    public class ClearCompanyCommandAuthorizer : IAuthorizer<ClearCompanyCommand>
    {
        private readonly IUserAccessor _userAccessor;
        private readonly IMediator _mediator;
        public ClearCompanyCommandAuthorizer(IUserAccessor userAccessor,
            IMediator mediator)
        {
        ...
        public async Task AuthorizeAsync(ClearCompanyCommand request, CancellationToken cancellationToken = default)
        {
